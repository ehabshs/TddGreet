...
class Test {
  ...
  execute(command, environment = {}, execOptions = {}) {
    const env = Object.assign({}, this.env, environment, {FORCE_COLOR: undefined});
    const options = Object.assign({}, {cwd: this.tmp, env}, execOptions);

    if (this.hasTmp()) {
      return sh.exec(`node '${this.script}' ${command}`, options);
    }
  }
